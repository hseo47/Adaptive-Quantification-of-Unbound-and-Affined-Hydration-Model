...
n_units = 10
E_PDMS = 2  # MPa — must match the value used in the generator script
...
ref_filename = os.path.join(base_dir, output_folder, f"n{n_units}_E{E_PDMS:.1f}".replace('.', '_') + "_hyd_distrib.txt")
try:
